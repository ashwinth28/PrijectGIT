...
public class PMG_StepDefinition extends LibGlobal {

	public static WebDriver driver;

	@Given("User on the login page for PMG")
	public void user_on_the_login_page_for_pmg() {
...
//		driver.get("http://localhost:8080/#/");
	...
	@Given("User enters the SCM Team Member {string} and {string} for PMG")
	public void user_enters_the_scm_team_member_and_for_pmg(String username, String password) {
	...
	public void user_create_the_po_request_for_po_order_for_pmg() throws InterruptedException, IOException {
		...
		String mas_data2 = getData("PMG Master Fields", 11, 3);
...
//				j.executeScript("arguments[0].click();", checkBox1);
	...
	public void user_click_on_the_save_button_for_pmg() throws InterruptedException {
		try {
			Thread.sleep(500);
	...
	public void user_click_on_the_Edit_button_for_pmg() {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	...
	public void user_verify_the_po_and_providing_pre_approval_for_pmg() throws InterruptedException {
	...
	public void user_verifies_the_po_status_has_been_changed_and_signout_for_pmg() throws InterruptedException {
	...
	@Given("User enters the Operations Head {string} and {string} for PMG")
	public void user_enters_the_operations_head_and_for_pmg(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	@Given("User verify the PO and providing Final-Approval for PMG")
	public void user_verify_the_po_and_providing_final_approval_for_pmg() throws InterruptedException {
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		WebElement dropdown = driver.findElement(By.xpath("(//div//app-form-select//select)"));
		if (dropdown.isEnabled()) {
			Select s = new Select(dropdown);
	...
	@Given("User click on the Issue icon for PMG")
	public void user_click_on_the_issue_icon_for_pmg() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement purchaseOrderBtn = driver.findElement(By.xpath("(//a[contains(text(),'Purchase Order')])[1]"));
	...
	public void user_click_on_the_issue_button_for_pmg() throws InterruptedException {
	...
	public void user_verifies_the_po_status_has_been_changed_to_issued_and_signout_for_pmg()
	...
	@Given("User enters the Store Team Member {string} and {string} for PMG")
	public void user_enters_the_store_team_member_and_for_pmg(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	public void user_create_the_grn_request_for_fully_received_for_pmg() throws InterruptedException, IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		String mas_data1 = getData("PMG Master Fields", 11, 2);
		...
		String mas_data2 = getData("PMG Master Fields", 11, 4);
		...
		String mas_data3 = getData("PMG Master Fields", 11, 5);
		...
		String mas_data4 = getData("PMG Master Fields", 11, 3);
	...
	public void user_select_the_fully_received_status_from_the_filter_for_pmg() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	...
	public void user_click_on_the_pmg_edit_button() throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
	...
	@When("User click on the edit button for PMG")
	public void user_click_on_the_edit_button_for_pmg() throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement receiptmodule = driver.findElement(By.xpath("(//a[contains(text(),'Receipt')])[1]"));
		JavascriptExecutor j = (JavascriptExecutor) driver;
	...
	public void user_move_the_stock_to_the_store_for_pmg() {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebElement checkBox = driver.findElement(By.xpath("(//input[@type='checkbox'])[2]"));
		j.executeScript("arguments[0].click();", checkBox);
	...
	public void user_click_on_the_signout_button_for_pmg() throws InterruptedException {
		WebElement profileClick = driver.findElement(By.xpath("(//app-header//div//div//span[@class = 'd-block'])[1]"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollTo(0,0);", profileClick);
		Thread.sleep(1000);
	...
	@Given("User enters the PM Team Member {string} and {string} for PMG")
	public void user_enters_the_pm_team_member_and_for_pmg(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	public void user_create_the_pmg_request() throws InterruptedException, IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		String request = getData("PMG Master Fields", 1, 0);
		select(requestType).selectByVisibleText(request);
		Thread.sleep(500);

		WebElement wareHouse = (driver.findElement(By.xpath("(.//div//select)[3]")));
		String warehouse_string = getData("PMG Master Fields", 1, 1);
		select(wareHouse).selectByVisibleText(warehouse_string);

		WebElement purpose = (driver.findElement(By.xpath("(.//div//select)[5]")));
		String purpose_string = getData("PMG Master Fields", 1, 2);
		select(purpose).selectByVisibleText(purpose_string);

		WebElement issueType = (driver.findElement(By.xpath("(.//div//select)[6]")));
		String issue_type_string = getData("PMG Master Fields", 1, 8);
		select(issueType).selectByVisibleText(issue_type_string);

//		WebElement expected_return_date = driver.findElement(By.xpath("(//input [@type='date'])[1]"));
//		String date = LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
//		expected_return_date.sendKeys(date);

		WebElement product_code_input = driver.findElement(By.xpath("(//input[@type='text'])[1]"));
		String product_input = getData("PMG Master Fields", 1, 3);
		...
		WebElement customer_name = driver.findElement(By.xpath("(//input[@type='text'])[2]"));
		String customer_name_string = getData("PMG Master Fields", 1, 13);
		int maxretries = 3;
		for (int i = 0; i < maxretries; i++) {
			try {
				customer_name = driver.findElement(By.xpath("(//input[@type='text'])[2]"));
		...
		WebElement requestor_name = driver.findElement(By.xpath("(//input[@type='text'])[4]"));
		String requestor_name_string = getData("PMG Master Fields", 1, 14);
		requestor_name.sendKeys(requestor_name_string);

		WebElement requestor_team = driver.findElement(By.xpath("(//input[@type='text'])[5]"));
		String requestor_team_string = getData("PMG Master Fields", 1, 15);
		requestor_team.sendKeys(requestor_team_string);

		WebElement jira_number = driver.findElement(By.xpath("(//input[@type='text'])[6]"));
...
//1st Line
		...
		String cost_center_string = getData("PMG Grid Fields", 1, 0);
		...
		String expense_category_string = getData("PMG Grid Fields", 1, 1);
		...
		String material_type_string = getData("PMG Grid Fields", 1, 2);
		...
		String material_name_string = getData("PMG Grid Fields", 1, 3);
		...
		String required_qty_string = getData("PMG Grid Fields", 1, 4);
...
//2nd Line
		...
		for (int i = 0; i < maxretries; i++) {
			try {
				...
				String cost_center_string1 = getData("PMG Grid Fields", 2, 0);
		...
		for (int i = 0; i < maxretries; i++) {
			try {
				...
				String expense_category_string1 = getData("PMG Grid Fields", 2, 1);
		...
		for (int i = 0; i < maxretries; i++) {
			try {
				...
				WebElement material_type1 = driver.findElement(
						By.xpath(".//div[@style='top:25px']//div[contains (@class, 'slick-cell l4 r4')]//select"));
				String material_type_string1 = getData("PMG Grid Fields", 2, 2);
		...
		for (int i = 0; i < maxretries; i++) {
			try {
				...
				WebElement material_name1 = driver.findElement(
						By.xpath(".//div[@style='top:25px']//div[contains (@class, 'slick-cell l5 r5')]//input"));
				String material_name_string1 = getData("PMG Grid Fields", 2, 3);
		...
		WebElement required_qty1 = driver.findElement(
				By.xpath(".//div[@style='top:25px']//div[contains (@class, 'slick-cell l7 r7')]//input"));
		String required_qty_string1 = getData("PMG Grid Fields", 2, 4);
...
//3rd Line
		...
		String cost_center_string2 = getData("PMG Grid Fields", 3, 0);
		...
		String expense_category_string2 = getData("PMG Grid Fields", 3, 1);
		...
		String material_type_string2 = getData("PMG Grid Fields", 3, 2);
		...
		for (int i = 0; i < maxretries; i++) {
			try {
				...
				String material_name_string2 = getData("PMG Grid Fields", 3, 3);
		...
		String required_qty_string2 = getData("PMG Grid Fields", 3, 4);
...
//4th Line
		...
		String cost_center_string3 = getData("PMG Grid Fields", 4, 0);
		...
		String expense_category_string3 = getData("PMG Grid Fields", 4, 1);
		...
		String material_type_string3 = getData("PMG Grid Fields", 4, 2);
		...
		for (int i = 0; i < maxretries; i++) {
			try {
				...
				String material_name_string3 = getData("PMG Grid Fields", 4, 3);
		...
		String required_qty_string3 = getData("PMG Grid Fields", 4, 4);
...
//5th Line
		...
		String cost_center_string4 = getData("PMG Grid Fields", 5, 0);
		...
		String expense_category_string4 = getData("PMG Grid Fields", 5, 1);
		...
		String material_type_string4 = getData("PMG Grid Fields", 5, 2);
		...
		for (int i = 0; i < maxretries; i++) {
			try {
				...
				String material_name_string4 = getData("PMG Grid Fields", 5, 3);
		...
		String required_qty_string4 = getData("PMG Grid Fields", 5, 4);
	...
	public void user_select_the_pmg_requested_status_from_the_filter() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		String store_string = getData("PMG Master Fields", 1, 10);
		...
		String requestType_string = getData("PMG Master Fields", 1, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement PMGStatus = driver.findElement(By.xpath("//select[@name='generalissuestatusid']"));
		String PMGStatus_string = getData("PMG Master Fields", 1, 12);
		select(PMGStatus).selectByVisibleText(PMGStatus_string);
		Thread.sleep(3000);
	}

	@When("User Approve the PMG Request")
	public void user_approve_the_pmg_request() throws IOException {
		WebElement approvalStatus = driver.findElement(By.xpath("(//select)[7]"));
		String approvalStatus_string = getData("PMG Master Fields", 1, 16);
	...
	public void user_select_the_pmg_approved_status_from_the_filter_for_pmg() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("PMG Master Fields", 2, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("PMG Master Fields", 2, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement PMGStatus = driver.findElement(By.xpath("//select[@name='generalissuestatusid']"));
		String PMGStatus_string = getData("PMG Master Fields", 2, 12);
		select(PMGStatus).selectByVisibleText(PMGStatus_string);
		Thread.sleep(3000);
	}

	@When("User click on the Issue icon for Issue Module for PMG")
	public void user_click_on_the_issue_icon_for_issue_module_for_pmg() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
	...
	public void user_select_the_pmg_issued_status_from_the_filter_for_pmg() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("PMG Master Fields", 3, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("PMG Master Fields", 3, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement PMGStatus = driver.findElement(By.xpath("//select[@name='generalissuestatusid']"));
		String PMGStatus_string = getData("PMG Master Fields", 3, 12);
		select(PMGStatus).selectByVisibleText(PMGStatus_string);
		Thread.sleep(3000);
	}

	@Then("User verifies the PMG Status has been changed to Issued and Signout for PMG")
	public void user_verifies_the_pmg_status_has_been_changed_to_issued_and_signout_for_pmg()
			throws InterruptedException {
		WebElement successfully_Issued = driver
				.findElement(By.xpath("//app-wstable//div[@class='ws-table-head']//table[@role='grid']//tbody//tr[1]"));
		System.out.println("Successfull PMG Issued : " + successfully_Issued.getText());
		Thread.sleep(1000);
	...
	public void user_enter_the_partially_issued_qty_for_pmg() throws IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement partiallyIssueQty1 = driver
				.findElement(By.xpath(".//div[contains (@class, 'slick-cell l13 r13')]//input"));
		String partiallyIssueQty_string = getData("PMG Master Fields", 1, 17);
		partiallyIssueQty1.sendKeys(partiallyIssueQty_string);
	}

	@When("User select the Partialy Issued status from the filter for PMG")
	public void user_select_the_partialy_issued_status_from_the_filter_for_pmg() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("PMG Master Fields", 4, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("PMG Master Fields", 4, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement PMGStatus = driver.findElement(By.xpath("//select[@name='generalissuestatusid']"));
		String PMGStatus_string = getData("PMG Master Fields", 4, 12);
		select(PMGStatus).selectByVisibleText(PMGStatus_string);
		Thread.sleep(3000);
	}
