...
public class MRI_StepDefinition extends LibGlobal{
...
//		driver.get("http://localhost:4200/#/");
	...
	public void user_create_the_po_request_for_po_order_rm_domestic() throws IOException, InterruptedException {
//		excelwrite();
...
//			driver.findElement(By.xpath(".//div[contains (@class, 'slick-cell l14 r14')]")).click();
	...
	public void user_create_the_grn_request_for_fully_received_po_order_rm_domestic()
		...
		String mas_data4 = getData("MRI Master Fields", 11, 3);
...
//		selectOptionByIndex(purCategory, 2);
	...
	public void user_create_the_mri_request() throws InterruptedException, IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
	...
	public void user_select_the_mri_requested_status_from_the_filter() throws InterruptedException, IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
	...
	public void user_click_on_the_issue_icon_for_issue_module() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
	...
	@Given("User enters the Production Team Member {string} and {string}")
	public void user_enters_the_production_team_member_and(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	public void user_select_the_mri_issued_status_from_the_filter() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
	...
	public void user_click_on_the_dispatch_icon_for_issue_module() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
	...
	public void user_enters_the_completed_qty_for_mri() throws InterruptedException, IOException {
		WebElement completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[2]"));
		String completedQty_string = getData("MRI Master Fields", 1, 8);
		completed_Qty.sendKeys(completedQty_string);
	}
	
	@When("User enters the Partially Completed Qty for MRI")
	public void user_enters_the_partially_completed_qty_for_mri() throws IOException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement partially_completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[2]"));
		String completedQty_string = getData("MRI Master Fields", 1, 13);
	
		int maxretries = 3;
		for (int i = 0; i < maxretries; i++) {
			try {
				partially_completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[2]"));
				partially_completed_Qty.sendKeys(completedQty_string);
				break;
			} catch (StaleElementReferenceException e) {
				System.out.println("Maximum Retry Failed");
			}
	...
	public void user_select_the_mri_production_completed_status_from_the_filter()
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("MRI Master Fields", 3, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("MRI Master Fields", 3, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement MRIStatus = driver.findElement(By.xpath("//select[@name='mriissuestatusid']"));
		String MRIStatus_string = getData("MRI Master Fields", 3, 12);
		select(MRIStatus).selectByVisibleText(MRIStatus_string);
		Thread.sleep(3000);
	}

	@When("User enter the Received Qty and Item Location for MRI")
	public void user_enter_the_received_qty_and_item_location_for_mri() throws IOException {
		WebElement received_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[3]"));
		String receivedQty_string = getData("MRI Master Fields", 1, 9);
	...
	public void user_select_the_mri_partially_production_completed_status_from_the_filter() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("MRI Master Fields", 4, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("MRI Master Fields", 4, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement MRIStatus = driver.findElement(By.xpath("//select[@name='mriissuestatusid']"));
		String MRIStatus_string = getData("MRI Master Fields", 4, 12);
		select(MRIStatus).selectByVisibleText(MRIStatus_string);
		Thread.sleep(3000);
	}
	
	@When("User enter the Partially Production Completed Received Qty and Item Location for MRI")
	public void user_enter_the_partially_production_completed_received_qty_and_item_location_for_mri() throws IOException {
		WebElement received_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[4]"));
		String receivedQty_string = getData("MRI Master Fields", 1, 14);
		received_Qty.sendKeys(receivedQty_string);
	...
	public void user_verifies_the_mri_status_has_been_remain_the_same_as_partially_production_completed_status_and_signout_for_mri() throws InterruptedException {
	...
	public void user_enters_the_balance_completed_qty_for_mri() throws IOException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement balance_completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[2]"));
		String completedQty_string = getData("MRI Master Fields", 1, 15);
	
		int maxretries = 3;
		for (int i = 0; i < maxretries; i++) {
			try {
				balance_completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[2]"));
	...
	public void user_enter_the_partially_received_qty_and_item_location_for_mri() throws IOException {
		WebElement partially_received_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[4]"));
		String receivedQty_string = getData("MRI Master Fields", 1, 16);
	...
	public void user_select_the_mri_partially_received_status_from_the_filter() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("MRI Master Fields", 5, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("MRI Master Fields", 5, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement MRIStatus = driver.findElement(By.xpath("//select[@name='mriissuestatusid']"));
		String MRIStatus_string = getData("MRI Master Fields", 5, 12);
		select(MRIStatus).selectByVisibleText(MRIStatus_string);
		Thread.sleep(3000);
	}
	
	@When("User enter the Balance Received Qty and Item Location for MRI")
	public void user_enter_the_balance_received_qty_and_item_location_for_mri() throws IOException {
		WebElement balance_received_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[4]"));
		String receivedQty_string = getData("MRI Master Fields", 1, 17);
	...
	public void user_select_the_mri_received_status_from_the_filter() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("MRI Master Fields", 6, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("MRI Master Fields", 6, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement MRIStatus = driver.findElement(By.xpath("//select[@name='mriissuestatusid']"));
		String MRIStatus_string = getData("MRI Master Fields", 6, 12);
		select(MRIStatus).selectByVisibleText(MRIStatus_string);
		Thread.sleep(3000);
	}
	
	@Then("User verifies the MRI Status has been changed to Received and Signout for MRI")
	public void user_verifies_the_mri_status_has_been_changed_to_received_and_signout_for_mri() throws InterruptedException {
		WebElement received = driver
				.findElement(By.xpath("//app-wstable//div[@class='ws-table-head']//table[@role='grid']//tbody//tr[1]"));
		System.out.println("Received Status : " + received.getText());
		Thread.sleep(1000);
