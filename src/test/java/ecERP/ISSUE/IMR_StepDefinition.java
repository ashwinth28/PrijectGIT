...
public class IMR_StepDefinition extends LibGlobal {

	public static WebDriver driver;

	@Given("User on the login page for IMR")
	public void user_on_the_login_page_for_IMR() {
...
//		driver.get("http://localhost:8080/#/");
	...
	@Given("User enters the SCM Team Member {string} and {string} for IMR")
	public void user_enters_the_scm_team_member_and_for_IMR(String username, String password) {
	...
	public void user_create_the_po_request_for_po_order_for_IMR() throws InterruptedException, IOException {
		...
		String mas_data2 = getData("IMR Master Fields", 11, 3);
...
//				j.executeScript("arguments[0].click();", checkBox1);
	...
	public void user_click_on_the_save_button_for_IMR() throws InterruptedException {
		try {
			Thread.sleep(500);
	...
	public void user_click_on_the_Edit_button_for_IMR() {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	...
	public void user_verify_the_po_and_providing_pre_approval_for_IMR() throws InterruptedException {
	...
	public void user_verifies_the_po_status_has_been_changed_and_signout_for_IMR() throws InterruptedException {
	...
	@Given("User enters the Operations Head {string} and {string} for IMR")
	public void user_enters_the_operations_head_and_for_IMR(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	@Given("User verify the PO and providing Final-Approval for IMR")
	public void user_verify_the_po_and_providing_final_approval_for_IMR() throws InterruptedException {
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		WebElement dropdown = driver.findElement(By.xpath("(//div//app-form-select//select)"));
		if (dropdown.isEnabled()) {
			Select s = new Select(dropdown);
	...
	@Given("User click on the Issue icon for IMR")
	public void user_click_on_the_issue_icon_for_IMR() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement purchaseOrderBtn = driver.findElement(By.xpath("(//a[contains(text(),'Purchase Order')])[1]"));
	...
	public void user_click_on_the_issue_button_for_IMR() throws InterruptedException {
	...
	public void user_verifies_the_po_status_has_been_changed_to_issued_and_signout_for_IMR()
	...
	@Given("User enters the Store Team Member {string} and {string} for IMR")
	public void user_enters_the_store_team_member_and_for_IMR(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	public void user_create_the_grn_request_for_fully_received_for_IMR() throws InterruptedException, IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		String mas_data1 = getData("IMR Master Fields", 11, 2);
		...
		String mas_data2 = getData("IMR Master Fields", 11, 4);
		...
		String mas_data3 = getData("IMR Master Fields", 11, 5);
		...
		String mas_data4 = getData("IMR Master Fields", 11, 3);
	...
	public void user_select_the_fully_received_status_from_the_filter_for_IMR() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	...
	@When("User click on the IMR edit button")
	public void user_click_on_the_IMR_edit_button() throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
	...
	@When("User click on the edit button for IMR")
	public void user_click_on_the_edit_button_for_IMR() throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement receiptmodule = driver.findElement(By.xpath("(//a[contains(text(),'Receipt')])[1]"));
		JavascriptExecutor j = (JavascriptExecutor) driver;
	...
	public void user_move_the_stock_to_the_store_for_IMR() {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebElement checkBox = driver.findElement(By.xpath("(//input[@type='checkbox'])[2]"));
		j.executeScript("arguments[0].click();", checkBox);
	...
	public void user_click_on_the_signout_button_for_IMR() throws InterruptedException {
		WebElement profileClick = driver.findElement(By.xpath("(//app-header//div//div//span[@class = 'd-block'])[1]"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollTo(0,0);", profileClick);
		Thread.sleep(1000);
	...
	@Given("User enters the Camera Products Team Member {string} and {string} for IMR")
	public void user_enters_the_camera_products_team_member_and_for_imr(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	public void user_create_the_IMR_request() throws InterruptedException, IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		String product_code_string = getData("IMR Master Fields", 1, 3);
		...
		String customer_name_string = getData("IMR Master Fields", 1, 13);
		int maxretries = 3;
		for (int i = 0; i < maxretries; i++) {
			try {
		...
		String project_name_string = getData("IMR Master Fields", 1, 4);
...
//1st Line
		WebElement delete_btn = driver.findElement(By.xpath(".//div//button[@ptooltip='Delete']//i"));
		...
		String cost_center_string = getData("IMR Grid Fields", 1, 0);
		...
		String expense_category_string = getData("IMR Grid Fields", 1, 1);
...
//2nd Line
		...
		for (int i = 0; i < maxretries; i++) {
			try {
				...
				String cost_center_string1 = getData("IMR Grid Fields", 2, 0);
		...
		for (int i = 0; i < maxretries; i++) {
			try {
				...
				String expense_category_string1 = getData("IMR Grid Fields", 2, 1);
...
//3rd Line
		...
		String cost_center_string2 = getData("IMR Grid Fields", 3, 0);
		...
		String expense_category_string2 = getData("IMR Grid Fields", 3, 1);
...
//4th Line
		...
		String cost_center_string3 = getData("IMR Grid Fields", 4, 0);
		...
		String expense_category_string3 = getData("IMR Grid Fields", 4, 1);
...
//5th Line
		...
		String cost_center_string4 = getData("IMR Grid Fields", 5, 0);
		...
		String expense_category_string4 = getData("IMR Grid Fields", 5, 1);
...
//6th Line
		...
		String cost_center_string5 = getData("IMR Grid Fields", 6, 0);
		...
		String expense_category_string5 = getData("IMR Grid Fields", 6, 1);
...
//7th Line
		...
		String cost_center_string6 = getData("IMR Grid Fields", 7, 0);
		...
		String expense_category_string6 = getData("IMR Grid Fields", 7, 1);
	...
	public void user_select_the_IMR_requested_status_from_the_filter() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		String store_string = getData("IMR Master Fields", 1, 10);
		...
		String requestType_string = getData("IMR Master Fields", 1, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement IMRStatus = driver.findElement(By.xpath("//select[@name='imrissuestatusid']"));
		String IMRStatus_string = getData("IMR Master Fields", 1, 12);
		select(IMRStatus).selectByVisibleText(IMRStatus_string);
		Thread.sleep(3000);
	}

	@When("User click on the Issue icon for Issue Module for IMR")
	public void user_click_on_the_issue_icon_for_issue_module_for_IMR() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
	...
	public void user_select_the_IMR_issued_status_from_the_filter_for_IMR() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("IMR Master Fields", 3, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("IMR Master Fields", 3, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement IMRStatus = driver.findElement(By.xpath("//select[@name='imrissuestatusid']"));
		String IMRStatus_string = getData("IMR Master Fields", 3, 12);
		select(IMRStatus).selectByVisibleText(IMRStatus_string);
		Thread.sleep(3000);
	}

	@Then("User verifies the IMR Status has been changed to Issued and Signout for IMR")
	public void user_verifies_the_IMR_status_has_been_changed_to_issued_and_signout_for_IMR()
			throws InterruptedException {
		WebElement successfully_Issued = driver
				.findElement(By.xpath("//app-wstable//div[@class='ws-table-head']//table[@role='grid']//tbody//tr[1]"));
		System.out.println("Successfull IMR Issued : " + successfully_Issued.getText());
		Thread.sleep(1000);
	...
	public void user_enter_the_partially_issued_qty_for_IMR() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement fifo_checkbox1 = driver.findElement(By.xpath(".//div[contains (@class, 'slick-cell l14 r14')]//input"));
		...
		WebElement partiallyIssueQty1 = driver
				.findElement(By.xpath(".//div[contains (@class, 'slick-cell l13 r13')]//input"));
		String partiallyIssueQty_string = getData("IMR Master Fields", 1, 17);
		partiallyIssueQty1.sendKeys(partiallyIssueQty_string);
	}

	@When("User select the Partialy Issued status from the filter for IMR")
	public void user_select_the_partialy_issued_status_from_the_filter_for_IMR()
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("IMR Master Fields", 4, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("IMR Master Fields", 4, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement IMRStatus = driver.findElement(By.xpath("//select[@name='imrissuestatusid']"));
		String IMRStatus_string = getData("IMR Master Fields", 4, 12);
		select(IMRStatus).selectByVisibleText(IMRStatus_string);
		Thread.sleep(3000);
	}
