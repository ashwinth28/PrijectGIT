...
public class MRD_StepDefinition extends LibGlobal{
	...
	public void user_on_the_login_page_for_mrd() {
...
//		driver.get("http://localhost:4200/#/");
	...
	@Given("User enters the SCM Team Member {string} and {string} for MRD")
	public void user_enters_the_scm_team_member_and_for_mrd(String username, String password) {
	...
	public void user_create_the_po_request_for_po_order_for_mrd() throws IOException, InterruptedException {
//		excelwrite();
		...
		String mas_data2 = getData("MRD Master Fields", 11, 3);
...
//				j.executeScript("arguments[0].click();", checkBox1);
	...
	public void user_click_on_the_save_button_for_mrd() throws InterruptedException {
		try {
			Thread.sleep(500);
...
//			System.out.println("Successfull PO Creation : " + successfullPoCreation.getText());
	...
	public void user_click_on_the_Edit_button_for_mrd() {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	...
	public void user_verify_the_po_and_providing_pre_approval_for_mrd() throws InterruptedException {
	...
	public void user_verifies_the_po_status_has_been_changed_and_signout_for_mrd() throws InterruptedException {
	...
	@Given("User enters the Operations Head {string} and {string} for MRD")
	public void user_enters_the_operations_head_and_for_mrd(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	@Given("User verify the PO and providing Final-Approval for MRD")
	public void user_verify_the_po_and_providing_final_approval_for_mrd() throws InterruptedException {
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		WebElement dropdown = driver.findElement(By.xpath("(//div//app-form-select//select)"));
		if (dropdown.isEnabled()) {
			Select s = new Select(dropdown);
	...
	@Given("User click on the Issue icon for MRD")
	public void user_click_on_the_issue_icon_for_mrd() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement purchaseOrderBtn = driver.findElement(By.xpath("(//a[contains(text(),'Purchase Order')])[1]"));
	...
	public void user_click_on_the_issue_button_for_mrd() throws InterruptedException {
	...
	public void user_verifies_the_po_status_has_been_changed_to_issued_and_signout_for_mrd() throws InterruptedException {
	...
	@Given("User enters the Store Team Member {string} and {string} for MRD")
	public void user_enters_the_store_team_member_and_for_mrd(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	public void user_create_the_grn_request_for_fully_received_for_mrd()
		...
		String mas_data1 = getData("MRD Master Fields", 11, 2);
		...
		String mas_data2 = getData("MRD Master Fields", 11, 4);
		...
		String mas_data3 = getData("MRD Master Fields", 11, 5);
		...
		String mas_data4 = getData("MRD Master Fields", 11, 3);
	...
	public void user_select_the_fully_received_status_from_the_filter_for_mrd()
...
//		selectOptionByIndex(purCategory, 2);
	...
	@When("User click on the edit button for MRD")
	public void user_click_on_the_edit_button_for_mrd() throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement receiptmodule = driver.findElement(By.xpath("(//a[contains(text(),'Receipt')])[1]"));
		JavascriptExecutor j = (JavascriptExecutor) driver;
	...
	public void user_move_the_stock_to_the_store_for_mrd() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebElement checkBox = driver.findElement(By.xpath("(//input[@type='checkbox'])[2]"));
		j.executeScript("arguments[0].click();", checkBox);
	...
	public void user_click_on_the_signout_button_for_mrd() throws InterruptedException {
		WebElement profileClick = driver.findElement(By.xpath("(//app-header//div//div//span[@class = 'd-block'])[1]"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollTo(0,0);", profileClick);
		Thread.sleep(1000);
	...
	@Given("User enters the PM Team Member {string} and {string} for MRD")
	public void user_enters_the_pm_team_member_and_for_mrd(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	public void user_create_the_mrd_request() throws InterruptedException, IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
...
//		for (int l = 0; l < max; l++) {
		...
		for (WebElement webElement : product_code_outputlist) {
			String list = webElement.getText();
			if (list.contains(product_output)) {
				Thread.sleep(500);
				JavascriptExecutor k = (JavascriptExecutor) driver;
				k.executeScript("arguments[0].click();", webElement);
				System.out.println(webElement);
...
//		}
	...
	public void user_select_the_mrd_requested_status_from_the_filter() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
	...
	public void user_click_on_the_issue_icon_for_issue_module_for_mrd() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
	...
	@Given("User enters the Production Team Member {string} and {string} for MRD")
	public void user_enters_the_production_team_member_and_for_mrd(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	public void user_select_the_mrd_issued_status_from_the_filter() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
	...
	public void user_click_on_the_dispatch_icon_for_issue_module_for_mrd() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
	...
	public void user_enters_the_completed_qty_for_mrd() throws IOException {
		WebElement completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[4]"));
		String completedQty_string = getData("MRD Master Fields", 1, 8);
		completed_Qty.sendKeys(completedQty_string);
	}

	@When("User enters the Partially Completed Qty for MRD")
	public void user_enters_the_partially_completed_qty_for_mrd() throws IOException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[4]"));
		String completedQty_string = getData("MRD Master Fields", 1, 17);
	...
	public void user_enters_the_balance_completed_qty_for_mrd() throws IOException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement balance_completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[4]"));
		String completedQty_string = getData("MRD Master Fields", 1, 20);

		int maxretries = 3;
		for (int i = 0; i < maxretries; i++) {
			try {
				balance_completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[4]"));
	...
	public void user_select_the_mrd_production_completed_status_from_the_filter()
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("MRD Master Fields", 3, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("MRD Master Fields", 3, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement MRDStatus = driver.findElement(By.xpath("//select[@name='issuestatusid']"));
		String MRDStatus_string = getData("MRD Master Fields", 3, 12);
		select(MRDStatus).selectByVisibleText(MRDStatus_string);
		Thread.sleep(3000);
	}

	@When("User select the MRD Partially Production Completed status from the filter")
	public void user_select_the_mrd_partially_production_completed_status_from_the_filter()
			throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("MRD Master Fields", 5, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("MRD Master Fields", 5, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement MRDStatus = driver.findElement(By.xpath("//select[@name='issuestatusid']"));
		String MRDStatus_string = getData("MRD Master Fields", 5, 12);
		int maxretries = 3;
		for (int i = 0; i < maxretries; i++) {
			try {
				MRDStatus = driver.findElement(By.xpath("//select[@name='issuestatusid']"));
				select(MRDStatus).selectByVisibleText(MRDStatus_string);
				break;
			} catch (StaleElementReferenceException e) {
				System.out.println("Maximum Retry Failed");
	...
	public void user_approve_the_mrd_request() throws IOException {
		WebElement approvalStatus = driver.findElement(By.xpath("(//select)[9]"));
		String approvalStatus_string = getData("MRD Master Fields", 1, 19);
		select(approvalStatus).selectByVisibleText(approvalStatus_string);
	}

	@Given("User enters the Logistics Team Member {string} and {string} for MRD")
	public void user_enters_the_logistics_team_member_and_for_mrd(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	public void user_click_the_shipment_received_checkbox_for_mrd() throws IOException {
	...
	public void user_select_the_mrd_shipment_received_status_from_the_filter()
			throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("MRD Master Fields", 4, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("MRD Master Fields", 4, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement MRDStatus = driver.findElement(By.xpath("//select[@name='issuestatusid']"));
		String MRDStatus_string = getData("MRD Master Fields", 4, 12);
		select(MRDStatus).selectByVisibleText(MRDStatus_string);
		Thread.sleep(3000);
	}

	@When("User select the MRD Approved status from the filter")
	public void user_select_the_mrd_approved_status_from_the_filter() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("MRD Master Fields", 6, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("MRD Master Fields", 6, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement MRDStatus = driver.findElement(By.xpath("//select[@name='issuestatusid']"));
		String MRDStatus_string = getData("MRD Master Fields", 6, 12);
		select(MRDStatus).selectByVisibleText(MRDStatus_string);
		Thread.sleep(3000);
	}
	
	@When("User select the MRD Partially Dispatched status from the filter")
	public void user_select_the_mrd_partially_dispatched_status_from_the_filter() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("MRD Master Fields", 7, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("MRD Master Fields", 7, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement MRDStatus = driver.findElement(By.xpath("//select[@name='issuestatusid']"));
		String MRDStatus_string = getData("MRD Master Fields", 7, 12);
		select(MRDStatus).selectByVisibleText(MRDStatus_string);
		Thread.sleep(3000);
	}
	
	@When("User select the MRD Dispatched status from the filter")
	public void user_select_the_mrd_dispatched_status_from_the_filter() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("MRD Master Fields", 8, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("MRD Master Fields", 8, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement MRDStatus = driver.findElement(By.xpath("//select[@name='issuestatusid']"));
		String MRDStatus_string = getData("MRD Master Fields", 8, 12);
		select(MRDStatus).selectByVisibleText(MRDStatus_string);
		Thread.sleep(3000);
	}

	@When("User enter the Shipping Qty with isDispatched Checkbox for MRD")
	public void user_enter_the_shipping_qty_with_is_dispatched_checkbox_for_mrd() throws IOException {
		WebElement shipping_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input[@type='text'])[13]"));
		String shippingQty_string = getData("MRD Master Fields", 1, 16);
	...
	public void user_enter_the_partially_shipping_qty_with_is_dispatched_checkbox_for_mrd() throws IOException {
		WebElement partially_shipping_Qty = driver
				.findElement(By.xpath("(//div//app-form-text//div//input[@type='text'])[13]"));
		String partially_shipping_Qty_string = getData("MRD Master Fields", 1, 18);
	...
	public void user_enter_the_balance_shipping_qty_for_mrd() throws IOException {
		WebElement balance_shipping_Qty = driver
				.findElement(By.xpath("(//div//app-form-text//div//input[@type='text'])[13]"));
		String balance_shipping_Qty_string = getData("MRD Master Fields", 1, 21);
	...
	public void user_verifies_the_mrd_status_has_been_changed_to_dispatched_and_signout_for_mrd() throws InterruptedException {
		WebElement successfully_dispatched = driver
				.findElement(By.xpath("//app-wstable//div[@class='ws-table-head']//table[@role='grid']//tbody//tr[1]"));
		System.out.println("Successfull MRD Dispatched : " + successfully_dispatched.getText());
		Thread.sleep(1000);
