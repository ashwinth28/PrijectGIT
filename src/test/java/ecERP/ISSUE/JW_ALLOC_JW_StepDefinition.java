...
public class JW_ALLOC_JW_StepDefinition extends LibGlobal {
	
	public static WebDriver driver;

	@Given("User on the login page for JW Alloc")
	public void user_on_the_login_page_for_jw_alloc() {
...
//		driver.get("http://localhost:4200/#/");
	...
	@Given("User enters the SCM Team Member {string} and {string} for JW Alloc")
	public void user_enters_the_scm_team_member_and_for_jw_alloc(String username, String password) {
	...
	public void user_create_the_po_request_for_po_order_for_jw_alloc()
		...
		String mas_data = getData("JW Alloc Master Fields", 11, 0);
		select(branch).selectByVisibleText(mas_data);
		Thread.sleep(500);

		WebElement wareHouse = (driver.findElement(By.xpath("(//select)[2]")));
		String mas_data1 = getData("JW Alloc Master Fields", 11, 1);
		...
		String mas_data2 = getData("JW Alloc Master Fields", 11, 3);
		...
		String mas_data3 = getData("JW Alloc Master Fields", 11, 4);
		selectOptionByText(orderType, mas_data3);

		WebElement materialType = driver.findElement(By.xpath("(//select)[6]"));
		String mas_data4 = getData("JW Alloc Master Fields", 11, 5);
	...
	public void user_click_on_the_save_button_for_jw_alloc() throws InterruptedException {
		try {
			Thread.sleep(500);
	...
	public void user_click_on_the_Edit_button_for_jw_alloc() {
	...
	public void user_verify_the_po_and_providing_pre_approval_for_jw_alloc() throws InterruptedException {
	...
	public void user_verifies_the_po_status_has_been_changed_and_signout_for_jw_alloc() throws InterruptedException {
	...
	@Given("User enters the Operations Head {string} and {string} for JW Alloc")
	public void user_enters_the_operations_head_and_for_jw_alloc(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	@Given("User verify the PO and providing Final-Approval for JW Alloc")
	public void user_verify_the_po_and_providing_final_approval_for_jw_alloc() throws InterruptedException {
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		WebElement dropdown = driver.findElement(By.xpath("(//div//app-form-select//select)"));
		if (dropdown.isEnabled()) {
			Select s = new Select(dropdown);
	...
	@Given("User click on the Issue icon for JW Alloc")
	public void user_click_on_the_issue_icon_for_jw_alloc() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement purchaseOrderBtn = driver.findElement(By.xpath("(//a[contains(text(),'Purchase Order')])[1]"));
	...
	public void user_click_on_the_issue_button_for_jw_alloc() throws InterruptedException {
	...
	public void user_verifies_the_po_status_has_been_changed_to_issued_and_signout_for_jw_alloc()
	...
	@Given("User enters the Store Team Member {string} and {string} for JW Alloc")
	public void user_enters_the_store_team_member_and_for_jw_alloc(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	public void user_create_the_grn_request_for_fully_received_for_jw_alloc()
		...
		String mas_data1 = getData("JW Alloc Master Fields", 11, 2);
		...
		String mas_data2 = getData("JW Alloc Master Fields", 11, 4);
		...
		String mas_data3 = getData("JW Alloc Master Fields", 11, 5);
		...
		String mas_data4 = getData("JW Alloc Master Fields", 11, 3);
	...
	public void user_select_the_fully_received_status_from_the_filter_for_jw_alloc() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	...
	@When("User click on the edit button for JW Alloc")
	public void user_click_on_the_edit_button_for_jw_alloc() throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement receiptmodule = driver.findElement(By.xpath("(//a[contains(text(),'Receipt')])[1]"));
		JavascriptExecutor j = (JavascriptExecutor) driver;
	...
	public void user_move_the_stock_to_the_store_for_jw_alloc() {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebElement checkBox = driver.findElement(By.xpath("(//input[@type='checkbox'])[2]"));
		j.executeScript("arguments[0].click();", checkBox);
	...
	public void user_click_on_the_signout_button_for_jw_alloc() throws InterruptedException {
		WebElement profileClick = driver.findElement(By.xpath("(//app-header//div//div//span[@class = 'd-block'])[1]"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollTo(0,0);", profileClick);
		Thread.sleep(1000);
	...
	@Given("User enters the PM Team Member {string} and {string} for JW Alloc")
	public void user_enters_the_pm_team_member_and_for_jw_alloc(String username, String password) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		WebElement loginID = driver.findElement(By.xpath("//input[@id='loginkey'][1]"));
		loginID.sendKeys(username);
		WebElement loginPassword = driver.findElement(By.xpath("//input[@id='password'][1]"));
	...
	public void user_create_the_jw_alloc_request() throws InterruptedException, IOException, AWTException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		String product_code_string = getData("JW Alloc Master Fields", 1, 3);
		...
		String bomrev_string = getData("JW Alloc Master Fields", 1, 6);
		Thread.sleep(500);
		select(bom_rev_no).selectByVisibleText(bomrev_string);
		
		WebElement FG_qty = driver.findElement(By.xpath("(//input[@type='text'])[4]"));
		String FG_qty_string = getData("JW Alloc Master Fields", 1, 7);
		FG_qty.sendKeys(FG_qty_string);
		
		WebElement allocation_against_product = driver.findElement(By.xpath("(//input[@type='text'])[5]"));
		String allocation_against_product_string = getData("JW Alloc Master Fields", 1, 8);
		allocation_against_product.sendKeys(allocation_against_product_string);
		Thread.sleep(500);

		List<WebElement> allocation_against_productlist = driver.findElements(By.xpath("(//ul[@role='listbox'])[1]//li"));
		for (WebElement webElement : allocation_against_productlist) {
			String list = webElement.getText();
			if (list.contains(allocation_against_product_string)) {
				Thread.sleep(500);
				JavascriptExecutor k = (JavascriptExecutor) driver;
				k.executeScript("arguments[0].click();", webElement);
				System.out.println(webElement);
		...
		WebElement allocation_against_project = driver.findElement(By.xpath("(//input[@type='text'])[6]"));
		String allocation_against_project_string = getData("JW Alloc Master Fields", 1, 4);
		allocation_against_project.sendKeys(allocation_against_project_string);
		Thread.sleep(500);

		List<WebElement> allocation_against_projectlist = driver.findElements(By.xpath("(//ul[@role='listbox'])[1]//li"));
		for (WebElement webElement : allocation_against_projectlist) {
			String list = webElement.getText();
			if (list.contains(allocation_against_project_string)) {
				Thread.sleep(500);
				JavascriptExecutor k = (JavascriptExecutor) driver;
				k.executeScript("arguments[0].click();", webElement);
				System.out.println(webElement);
		...
		WebElement delete_btn = driver.findElement(By.xpath("//div//button[@tooltipposition='bottom'][2]//i"));
		j.executeScript("arguments[0].click();", delete_btn);
		j.executeScript("arguments[0].click();", delete_btn);
		Thread.sleep(500);
		
		WebElement rev_no = driver
				.findElement(By.xpath(".//div[@style='top:100px']//div[contains(@class, 'slick-cell l5 r5')]"));
		j.executeScript("arguments[0].click();", rev_no);
		WebElement rev_no1 = driver.findElement(
				By.xpath(".//div[@style='top:100px']//div[contains(@class, 'slick-cell l5 r5')]//select"));

		int maxRetries = 3;
		for (int i = 0; i < maxRetries; i++) {
			try {
				Select dropdownSelect = new Select(rev_no1);
				java.util.List<WebElement> options = dropdownSelect.getOptions();
				dropdownSelect.selectByIndex(options.size() - 1);
				break;
			} catch (StaleElementReferenceException e) {
				rev_no = driver.findElement(
						By.xpath(".//div[@style='top:100px']//div[contains(@class, 'slick-cell l5 r5')]"));
				j.executeScript("arguments[0].click();", rev_no);
				rev_no1 = driver.findElement(
						By.xpath(".//div[@style='top:100px']//div[contains(@class, 'slick-cell l5 r5')]//select"));
			}
			Thread.sleep(500);
		}
	...
	public void user_select_the_jw_alloc_requested_status_from_the_filter()
		...
		String store_string = getData("JW Alloc Master Fields", 1, 10);
		...
		String requestType_string = getData("JW Alloc Master Fields", 1, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement JW_Alloc_Status = driver.findElement(By.xpath("//select[@name='allocationstatusid']"));
		String JW_Alloc_Status_string = getData("JW Alloc Master Fields", 1, 12);
		select(JW_Alloc_Status).selectByVisibleText(JW_Alloc_Status_string);
		Thread.sleep(3000);
	}

	@When("User click on the Issue icon for Issue Module for JW Alloc")
	public void user_click_on_the_issue_icon_for_issue_module_for_jw_alloc() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
	...
	public void user_select_the_jw_alloc_allocated_status_from_the_filter_for_jw_alloc()
			throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("JW Alloc Master Fields", 2, 10);
		select(store).selectByVisibleText(store_string);
		Thread.sleep(500);
		
		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("JW Alloc Master Fields", 2, 11);
		select(requestType).selectByVisibleText(requestType_string);
		Thread.sleep(500);
		
		WebElement JW_Alloc_Status = driver.findElement(By.xpath("//select[@name='allocationstatusid']"));
		String JW_Alloc_Status_string = getData("JW Alloc Master Fields", 2, 12);
		select(JW_Alloc_Status).selectByVisibleText(JW_Alloc_Status_string);
		Thread.sleep(3000);
	}

	@When("User click on the edit button for Issue Module for JW Alloc")
	public void user_click_on_the_edit_button_for_issue_module_for_jw_alloc() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement editBtn = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//table[@role='grid']//tbody//tr[1]//th//button[1]//i")));
	...
	public void user_enter_the_kit_location_and_move_to_alloc_qty_for_jw_alloc() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement kitLocation = driver.findElement(By.xpath("(//app-form-text//div//input [@type='text'])[3]"));
		wait.until(ExpectedConditions.visibilityOf(kitLocation));
		kitLocation.sendKeys("12");
		Thread.sleep(500);
		
		JW_Allocation_GRN_Selection(driver);
	...
	public void user_enter_the_release_qty_for_jw_alloc() throws IOException, InterruptedException {    
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebElement release_qty = driver
				.findElement(By.xpath(".//div[@style='top:0px']//div[contains (@class, 'slick-cell l15 r15')]"));
		j.executeScript("arguments[0].click();", release_qty);
		WebElement release_qty1 = driver
				.findElement(By.xpath(".//div[@style='top:0px']//div[contains (@class, 'slick-cell l15 r15')]//input"));
		String release_qty_string = getData("JW Alloc Master Fields", 1, 9);
		release_qty1.sendKeys(release_qty_string);
		driver.findElement(By.xpath(".//div[@style='top:0px']//div[contains (@class, 'slick-cell l16 r16')]")).click();
		Thread.sleep(500);
	}

	@When("User select the JW Alloc Request for Reallocation status from the filter for JW Alloc")
	public void user_select_the_jw_alloc_request_for_reallocation_status_from_the_filter_for_jw_alloc()
			throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("JW Alloc Master Fields", 3, 10);
		select(store).selectByVisibleText(store_string);
		Thread.sleep(500);
		
		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("JW Alloc Master Fields", 3, 11);
		select(requestType).selectByVisibleText(requestType_string);
		Thread.sleep(500);
		
		WebElement JW_Alloc_Status = driver.findElement(By.xpath("//select[@name='allocationstatusid']"));
		String JW_Alloc_Status_string = getData("JW Alloc Master Fields", 3, 12);
		select(JW_Alloc_Status).selectByVisibleText(JW_Alloc_Status_string);
		Thread.sleep(3000);
	}

	@When("User create the Job Work Request")
	public void user_create_the_job_work_request() throws InterruptedException, IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement requestType = (driver.findElement(By.xpath("(.//div//select)[1]")));
		String request = getData("JW Alloc Master Fields", 2, 0);
		select(requestType).selectByVisibleText(request);
		Thread.sleep(500);
		...
		WebElement vendor_name = (driver.findElement(By.xpath("(.//div//select)[6]")));
		String vendor_name_string = getData("JW Alloc Master Fields", 1, 15);
	...
	public void user_select_the_job_work_requested_status_from_the_filter_for_jw_alloc()
			throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("JW Alloc Master Fields", 4, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("JW Alloc Master Fields", 4, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement JW_Alloc_Status = driver.findElement(By.xpath("//select[@name='mriissuestatusid']"));
		String JW_Alloc_Status_string = getData("JW Alloc Master Fields", 4, 12);
		select(JW_Alloc_Status).selectByVisibleText(JW_Alloc_Status_string);
		Thread.sleep(3000);
	}

	@When("User create the PO Request for Testing and Services for JW Alloc")
	public void user_create_the_po_request_for_testing_and_services_for_jw_alloc()
			throws InterruptedException, IOException {
		WebElement purchaseOrderBtn = driver.findElement(By.xpath("(//a[contains(text(),'Purchase Order')])[1]"));
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		wait.until(ExpectedConditions.visibilityOfNestedElementsLocatedBy(purchaseOrderBtn,
...
//		System.out.println("Store : " + storeFieldText.getText());
		...
		WebElement orderType = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//select)[5]")));
		String mas_data3 = getData("JW Alloc Master Fields", 12, 4);
		selectOptionByText(orderType, mas_data3);
		...
		String name_String = getData("JW Alloc Master Fields", 12, 8);
		...
		String serviceDesc_String = getData("JW Alloc Master Fields", 12, 9);
		...
		String qty_String = getData("JW Alloc Master Fields", 1, 7);
		...
		String unitPrice_String = getData("JW Alloc Master Fields", 12, 10);
	...
	public void user_select_the_job_work_issued_status_from_the_filter_for_jw_alloc()
			throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("JW Alloc Master Fields", 5, 10);
		select(store).selectByVisibleText(store_string);
		Thread.sleep(500);
		
		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("JW Alloc Master Fields", 5, 11);
		select(requestType).selectByVisibleText(requestType_string);
		Thread.sleep(500);
		
		WebElement JW_Alloc_Status = driver.findElement(By.xpath("//select[@name='mriissuestatusid']"));
		String JW_Alloc_Status_string = getData("JW Alloc Master Fields", 5, 12);
		select(JW_Alloc_Status).selectByVisibleText(JW_Alloc_Status_string);
		Thread.sleep(3000);
	}

	@When("User create the GRN Request for Testing and Services for JW Alloc")
	public void user_create_the_grn_request_for_testing_and_services_for_jw_alloc()
			throws InterruptedException, IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement orderType = (driver
				.findElement(By.xpath("//*[@id='collapseOne']/div/div[3]/app-form-dyna-select/div/select")));
		String mas_data2 = getData("JW Alloc Master Fields", 12, 4);
		select(orderType).selectByVisibleText(mas_data2);
		Thread.sleep(300);
	...
	public void user_click_on_the_dispatch_icon_for_issue_module_for_jw_alloc() throws InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		WebElement issuesBtn = driver.findElement(By.xpath("(//a[contains(text(),'Issues')])[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(issuesBtn));
	...
	public void user_enters_the_completed_qty_for_jw_alloc() throws IOException {
		WebElement completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[5]"));
		String completedQty_string = getData("JW Alloc Master Fields", 1, 16);
		completed_Qty.sendKeys(completedQty_string);
	}

	@When("User enter the Kit Location and Move to Alloc Qty and Enter the Partially Alloc Qty for JW Alloc")
	public void user_enter_the_kit_location_and_move_to_alloc_qty_and_enter_the_partially_alloc_qty_for_jw_alloc()
			throws InterruptedException, IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		...
		String partially_allocqty_string = getData("JW Alloc Master Fields", 1, 17);
	...
	public void user_enters_the_remaining_qty_to_be_allocate_for_jw_alloc() throws InterruptedException, IOException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		WebElement remaining = driver
				.findElement(By.xpath(".//div[@style='top:0px']//div[contains (@class, 'slick-cell l20 r20')]"));
		j.executeScript("arguments[0].click();", remaining);
		WebElement remaining1 = driver
				.findElement(By.xpath(".//div[@style='top:0px']//div[contains (@class, 'slick-cell l20 r20')]//select"));
		
		int maxRetries = 3;
		for (int i = 0; i < maxRetries; i++) {
			try {
				Select dropdownSelect = new Select(remaining1);
				java.util.List<WebElement> options = dropdownSelect.getOptions();
				dropdownSelect.selectByIndex(options.size() - 1);
				break;
			} catch (StaleElementReferenceException e) {
				remaining = driver.findElement(
						By.xpath(".//div[@style='top:0px']//div[contains (@class, 'slick-cell l20 r20')]"));
				j.executeScript("arguments[0].click();", remaining);
				remaining1 = driver.findElement(
						By.xpath(".//div[@style='top:0px']//div[contains (@class, 'slick-cell l20 r20')]//select"));
			}
			Thread.sleep(500);
		}
		driver.findElement(By.xpath(".//div[@style='top:0px']//div[contains (@class, 'slick-cell l21 r21')]")).click();
		Thread.sleep(500);
		
		WebElement To_be_Alloc_Qty = driver
				.findElement(By.xpath(".//div[@style='top:0px']//div[contains(@class, 'slick-cell l17 r17')]"));
		j.executeScript("arguments[0].click();", To_be_Alloc_Qty);
		WebElement To_be_Alloc_Qty1 = driver
				.findElement(By.xpath(".//div[@style='top:0px']//div[contains(@class, 'slick-cell l17 r17')]//input"));
		String To_be_Alloc_Qty_string = getData("JW Alloc Master Fields", 1, 9);
		To_be_Alloc_Qty1.sendKeys(To_be_Alloc_Qty_string);
		Thread.sleep(500);
		driver.findElement(By.xpath(".//div[@style='top:0px']//div[contains (@class, 'slick-cell l18 r18')]")).click();
		Thread.sleep(500);
	}

	@When("User select the JW Alloc Partially Allocated status from the filter for JW Alloc")
	public void user_select_the_jw_alloc_partially_allocated_status_from_the_filter_for_jw_alloc()
			throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("JW Alloc Master Fields", 6, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("JW Alloc Master Fields", 6, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement JW_Alloc_Status = driver.findElement(By.xpath("//select[@name='allocationstatusid']"));
		String JW_Alloc_Status_string = getData("JW Alloc Master Fields", 6, 12);
		select(JW_Alloc_Status).selectByVisibleText(JW_Alloc_Status_string);
		Thread.sleep(3000);
	}
	
	@When("User enters the Partially Completed Qty for JW Alloc")
	public void user_enters_the_partially_completed_qty_for_jw_alloc() throws IOException {
		WebElement partially_completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[5]"));
		String partially_completedQty_string = getData("JW Alloc Master Fields", 1, 18);
	...
	public void user_select_the_job_work_partially_production_completed_status_from_the_filter_for_jw_alloc() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("JW Alloc Master Fields", 7, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("JW Alloc Master Fields", 7, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement Job_Work_Status = driver.findElement(By.xpath("//select[@name='mriissuestatusid']"));
		String Job_Work_Status_string = getData("JW Alloc Master Fields", 7, 12);
		select(Job_Work_Status).selectByVisibleText(Job_Work_Status_string);
		Thread.sleep(3000);
	}
	
	@When("User enters the Balance Completed Qty for JW Alloc")
	public void user_enters_the_balance_completed_qty_for_jw_alloc() throws IOException {
		WebElement balance_completed_Qty = driver.findElement(By.xpath("(//div//app-form-text//div//input [@type='text'])[5]"));
		String balance_completedQty_string = getData("JW Alloc Master Fields", 1, 19);
	...
	public void user_select_the_job_work_production_completed_status_from_the_filter_for_jw_alloc() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("JW Alloc Master Fields", 8, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("JW Alloc Master Fields", 8, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement Job_Work_Status = driver.findElement(By.xpath("//select[@name='mriissuestatusid']"));
		String Job_Work_Status_string = getData("JW Alloc Master Fields", 8, 12);
		select(Job_Work_Status).selectByVisibleText(Job_Work_Status_string);
		Thread.sleep(3000);
	}
	
	@Then("User verifies the Job Work Status has been changed to Production Complete and Signout for JW Alloc")
	public void user_verifies_the_job_work_status_has_been_changed_to_production_complete_and_signout_for_jw_alloc() throws InterruptedException {
	...
	public void user_select_the_job_work_partially_issued_status_from_the_filter_for_jw_alloc() throws IOException, InterruptedException {
		JavascriptExecutor j = (JavascriptExecutor) driver;
		...
		WebElement store = driver.findElement(By.xpath("//select[@name='requeststoreid']"));
		String store_string = getData("JW Alloc Master Fields", 9, 10);
		select(store).selectByVisibleText(store_string);

		WebElement requestType = driver.findElement(By.xpath("//select[@name='requesttypeid']"));
		String requestType_string = getData("JW Alloc Master Fields", 9, 11);
		select(requestType).selectByVisibleText(requestType_string);

		WebElement Job_Work_Status = driver.findElement(By.xpath("//select[@name='mriissuestatusid']"));
		String Job_Work_Status_string = getData("JW Alloc Master Fields", 9, 12);
		select(Job_Work_Status).selectByVisibleText(Job_Work_Status_string);
		Thread.sleep(3000);
	}
